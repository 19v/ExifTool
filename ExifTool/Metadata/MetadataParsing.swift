...
enum MetadataKeyTranslator {
    ...
    nonisolated private static let englishNamesByChineseName: [String: String] = [
        "Apple 参数": "Apple Parameters",
        "MakerNote 版本": "Maker Note Version",
        "AE 矩阵": "AE Matrix",
        "AE 稳定": "AE Stable",
        "AE 目标": "AE Target",
        "AE 平均值": "AE Average",
        "AF 稳定": "AF Stable",
        "加速度向量": "Acceleration Vector",
        "HDR 图像类型": "HDR Image Type",
        "连拍 UUID": "Burst UUID",
        "对焦距离范围": "Focus Distance Range",
        "OIS 模式": "OIS Mode",
        "内容标识符": "Content Identifier",
        "图像捕获类型": "Image Capture Type",
        "图像唯一 ID": "Image Unique ID",
        "实况照片视频索引": "Live Photo Video Index",
        "图像处理标志": "Image Processing Flags",
        "质量提示": "Quality Hint",
        "亮度噪声振幅": "Luminance Noise Amplitude",
        "照片 App 特征标志": "Photos App Feature Flags",
        "图像捕获请求 ID": "Image Capture Request ID",
        "HDR 余量": "HDR Headroom",
        "AF 性能": "AF Performance",
        "场景标志": "Scene Flags",
        "信噪比类型": "Signal-to-Noise Ratio Type",
        "信噪比": "Signal-to-Noise Ratio",
        "照片标识符": "Photo Identifier",
        "相机类型": "Camera Type",
        "对焦位置": "Focus Position",
        "HDR 增益": "HDR Gain",
        "AF 测量深度": "AF Measured Depth",
        "AF 置信度": "AF Confidence",
        "颜色校正矩阵": "Color Correction Matrix",
        "绿色鬼影抑制状态": "Green Ghost Mitigation Status",
        "摄影风格": "Photographic Style",
        "摄影风格渲染版本": "Photographic Style Rendering Version",
        "摄影风格预设": "Photographic Style Preset",
        "运行时间标志": "Run Time Flags",
        "运行时间值": "Run Time Value",
        "运行时间纪元": "Run Time Epoch",
        "运行时间刻度": "Run Time Scale",
